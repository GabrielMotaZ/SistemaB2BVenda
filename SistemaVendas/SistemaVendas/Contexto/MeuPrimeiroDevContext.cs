...
public partial class MeuPrimeiroDevContext : DbContext
{
    public MeuPrimeiroDevContext()
    {
    }

    public MeuPrimeiroDevContext(DbContextOptions<MeuPrimeiroDevContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=45.71.213.106,14005;Database=MeuPrimeiroDev;Integrated Security=False;User ID=andrey.jesus;Password=YZKLO@9cGASs$Hn0AS6;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__clientes__677F38F54FF247C7");
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCompanyNavigation).WithMany(p => p.Employees)
                ...
                .HasConstraintName("employeeCompany");
        });
        ...
        modelBuilder.Entity<Login>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEmployeeNavigation).WithMany(p => p.Logins)
                ...
                .HasConstraintName("FK__Login__idEmploye__247D636F");
        });
        ...
        {
            entity.HasKey(e => e.IdProduto).HasName("PK__produtos__BA38A6B866605D7D");
